        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<int>(type: "int", nullable: false),
                    DiaChiId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_DiaChis_DiaChiId",
                        column: x => x.DiaChiId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CTSanPham_DanhMucs_IdDanhMuc",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GioHangCTs_CTSanPham_IdCTSP",
                        column: x => x.IdCTSP,
                        principalTable: "CTSanPham",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HoaDonCTs_CTSanPham_IdCTSP",
                        column: x => x.IdCTSP,
                        principalTable: "CTSanPham",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
