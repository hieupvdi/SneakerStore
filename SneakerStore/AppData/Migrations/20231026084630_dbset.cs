        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_ChucVus_ChucVuId",
                        column: x => x.ChucVuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CTSanPham_GiamGias_GiamGiaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PhuongThucThanhToanCTs_PhuongThucThanhToans_PhuongThucThanhToanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhuongThucThanhToanCTs_PhuongThucThanhToanId",
                table: "PhuongThucThanhToanCTs",
                column: "PhuongThucThanhToanId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_ChucVuId",
                table: "Users",
                column: "ChucVuId");
